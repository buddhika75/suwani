...
public class PatientController implements Serializable {
    ...
    @EJB
    ClinicalSearch clinicalSearch;

    StreamedContent barcode;

    List<PatientEncounter> currentOpdVisits;
    List<PatientReport> currentLabReports;
    List<Bill> currentServiceBills;
    List<Bill> currentPharmacyBills;

    public void patientSelected() {
//        createPatientBarcode();
        currentOpdVisits = getClinicalSearch().listPatientEncounters(current);
        getPatientEncounterController().fillCurrentPatientEncounters(current);
...
//        p.getPerson().
    ...
    public List<PatientEncounter> getCurrentOpdVisits() {
        return currentOpdVisits;
    }

    public void setCurrentOpdVisits(List<PatientEncounter> currentOpdVisits) {
        this.currentOpdVisits = currentOpdVisits;
    }

    public List<PatientReport> getCurrentLabReports() {
        return currentLabReports;
    }

    public void setCurrentLabReports(List<PatientReport> currentLabReports) {
        this.currentLabReports = currentLabReports;
    }

    public List<Bill> getCurrentServiceBills() {
        return currentServiceBills;
    }

    public void setCurrentServiceBills(List<Bill> currentServiceBills) {
        this.currentServiceBills = currentServiceBills;
    }

    public List<Bill> getCurrentPharmacyBills() {
        return currentPharmacyBills;
    }

    public void setCurrentPharmacyBills(List<Bill> currentPharmacyBills) {
        this.currentPharmacyBills = currentPharmacyBills;
    }

    public ClinicalSearch getClinicalSearch() {
        return clinicalSearch;
    }

    public void setClinicalSearch(ClinicalSearch clinicalSearch) {
        this.clinicalSearch = clinicalSearch;
    }
