...
public class BhtSummeryController implements Serializable {
    ...
    public void changeDiscountListener(ChargeItemTotal cit) {
        ...
        cit.setDiscount(cit.getDiscount());
//        cit.setAdjustedTotal(cit.getTotal());
    ...
    public boolean checkBill() {
        ...
        if (getInwardBean().checkRefundedBill(getPatientEncounter(), BillType.InwardBill)) {
            UtilityController.addErrorMessage("Some Inward Service Bills Are Not Checked ");
            return true;
        }
        ...
        if (getInwardBean().checkRefundedBill(getPatientEncounter(), BillType.PharmacyBhtPre)) {
        ...
        if (getInwardBean().checkRefundedBill(getPatientEncounter(), BillType.StoreBhtPre)) {
        ...
        if (getInwardBean().checkRefundedBill(getPatientEncounter(), BillType.InwardOutSideBill)) {
            UtilityController.addErrorMessage("Some Inward Out Side Bills Are Not Checked ");
            return true;
        }
        ...
        if (getInwardBean().checkRefundedBill(getPatientEncounter(), BillType.InwardProfessional)) {
            UtilityController.addErrorMessage("Some Inward Pro Bills Are Not Checked ");
            return true;
        }
        ...
        if (getInwardBean().checkRefundedBill(getPatientEncounter(), BillType.InwardPaymentBill)) {
            UtilityController.addErrorMessage("Some Inward Payment Bills Are Not Checked ");
            return true;
        }
